...
public class LoginStepDefs {
    ...
    @Given("the title should contains Log in")
    ...
    public void Login_and_or_password_are_wrong_should_be_displayed(String string) {
LoginPage loginPage = new LoginPage();
string ="Login and/or password are wrong.";
String actual = loginPage.MessageFailLogin.getAttribute("class");
